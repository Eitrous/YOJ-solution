...
{
    //____qcodep____//
    _len = abs(_pa.getX() - _pb.getX()) + abs(_pa.getY() - _pb.getY());
}
...
int Rectangle::getOverlappedArea(Rectangle &rec)
{
    ...
    {
        //____qcodep____//
        //int s1 = max(abs(this->_RB.getX() - rec._LB.getX()), abs(this->_LB.getX() - rec._RB.getX())) * max(abs(this->_LT.getY() - rec._RB.getY()), abs(this->_LB.getY() - rec._RT.getY()));
        int s = min(abs(this->_RB.getX() - rec._LB.getX()), abs(this->_LB.getX() - rec._RB.getX())) * min(abs(this->_LT.getY() - rec._RB.getY()), abs(this->_LB.getY() - rec._RT.getY()));
        return s;
    }
}
...
{
    //____qcodep____//
    if ((this->_horizontal_line.getLength() + rec._horizontal_line.getLength() == abs( abs(this->_LB.getX() - rec._RB.getX()) - abs(this->_RB.getX() - rec._LB.getX()) )) && (this->_vertical_line.getLength() + rec._vertical_line.getLength() == abs(abs(this->_RT.getY() - rec._LB.getY()) - abs(this->_LB.getY() - rec._RT.getY()))))
        return false;
    else
        return true;
}
